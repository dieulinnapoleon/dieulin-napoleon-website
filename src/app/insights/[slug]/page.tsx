          ...
          <div className="mt-10 p-7 bg-gray-50 rounded-2xl flex gap-5 items-center flex-wrap">
            ...
            <div className="flex-1 min-w-[200px]">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Finance professional building his path in investment research and valuation. Master of Finance &amp; Master of Business Administration (Impact MBA) from Colorado State University.
              </p>
            </div>
          </div>
