        ...
        <section className="py-12 bg-navy">
          <div className="section-container">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {featured.map((p: any) => (
                <Link key={p.id} href={'/haiti-2075/proposals/' + p.id} className="group p-5 rounded-xl bg-white/5 border border-white/10 hover:border-gold/30 transition-all">
        ...
        <div className="section-container">
          {proposals.length === 0 ? (
            <div className="text-center py-16">
              ...
              <Link href="/haiti-2075/contribute" className="bg-gold hover:bg-gold-300 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-colors inline-flex items-center gap-2">Submit a Proposal <ArrowRight size={14} /></Link>
            </div>
          ) : (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {proposals.map((p: any) => (
                <Link key={p.id} href={'/haiti-2075/proposals/' + p.id} className="group p-6 rounded-2xl border border-gray-100 hover:border-gold/30 hover:shadow-sm transition-all">
          ...
          <div className="mt-12 text-center">
            <Link href="/haiti-2075/contribute" className="bg-gold hover:bg-gold-300 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-colors inline-flex items-center gap-2">Submit Your Idea <ArrowRight size={14} /></Link>
          </div>
        </div>
      </section>
    </div>
