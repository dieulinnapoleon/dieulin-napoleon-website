...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Haiti 2075', description: 'A 50-Year Civic Vision for National Transformation', images: [{ url: '/images/Dieulin-website.jpg' }] },
};
...
export default function Haiti2075Page() {
    ...
    <div>
      ...
      <section className="bg-navy pt-32 pb-20">
        <div className="section-container text-center max-w-4xl">
          ...
          <h1 className="font-display text-[clamp(36px,5vw,56px)] font-bold text-white mb-4">Haiti 2075</h1>
          <p className="text-xl text-gold/80 font-display italic mb-6">A 50-Year Civic Vision for National Transformation</p>
          <p className="text-white/50 text-base leading-relaxed max-w-2xl mx-auto mb-10">Haiti 2075 is a nonpartisan civic reflection initiative dedicated to organizing long-term ideas, policy priorities, and citizen contributions around Haiti&apos;s transformation over the next five decades.</p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/haiti-2075/contribute" className="bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-colors">Submit an Idea</Link>
            <Link href="/haiti-2075/proposals" className="border border-white/20 hover:bg-white/10 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-colors">View Proposals</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-section bg-white">
        <div className="section-container max-w-3xl">
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-6">Haiti 2075 is built on a simple conviction: sustained national transformation requires a shared vision that transcends individual administrations, aligns the efforts of all actors, and commits to measurable progress over decades, not election cycles.</p>
      ...
      <section className="py-section bg-navy">
        <div className="section-container max-w-3xl text-center">
          ...
          <p className="text-white/50 text-base leading-relaxed mb-4 max-w-xl mx-auto">Haiti 2075 invites constructive, respectful, and long-term ideas from every citizen who believes in Haiti&apos;s transformation.</p>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/haiti-2075/contribute" className="bg-gold hover:bg-gold-300 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-colors flex items-center gap-2">Submit a Proposal <ArrowRight size={14} /></Link>
            <Link href="/haiti-2075/proposals" className="border border-white/20 hover:bg-white/10 text-white px-6 py-3 rounded-xl text-sm font-semibold transition-colors">View Approved Proposals</Link>
          </div>
        </div>
      </section>
    </div>
