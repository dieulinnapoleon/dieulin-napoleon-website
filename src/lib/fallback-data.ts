...
export const FALLBACK_PROJECTS: Project[] = [
  {
    ...
    description: 'Creasti, Inc., a Delaware C corporation, is building a gamified savings and financial wellness app designed to help users build consistent saving habits through goals, streaks, challenges, AI coaching, education, and family circles.',
  ...
  },
  {
    ...
    role: 'Founder & Strategist', status: 'Concept',
  ...
  },
  {
    ...
    role: 'Founder & Concept Developer', status: 'Concept',
...
export const FALLBACK_SERVICES: Service[] = [
  {
    id: 'fs-1',
    title: "Financial Analysis & Research Support",
    description: "Supporting financial and investment analysis through company research, financial modeling, and valuation work, drawing on my graduate training, the CFA Level I curriculum, and ongoing hands-on experience.",
    for_whom: "Investment teams, small businesses, and organizations that need research or analytical support.",
    deliverables: "Company and industry research, financial statement analysis, and supporting models prepared with care and clearly stated assumptions.",
    outcomes: "Master of Finance from Colorado State University, Passed CFA Level I Exam, and ongoing hands-on experience through an investment research internship, a student-managed fund, and the CFA Institute Research Challenge.",
    icon: '',
    sort_order: 0,
    published: true,
  ...
  },
  {
    ...
    description: "Preparing business plans and feasibility studies, building on several years of leading this work as co-founder of GACED Consulting in Haiti.",
    for_whom: "Entrepreneurs, small businesses, and organizations preparing new ventures or projects, especially in Haiti.",
    deliverables: "Structured business plans, market analysis, financial projections, and feasibility assessments.",
    outcomes: "Several years co-leading GACED Consulting in Haiti, where business plans and feasibility studies were core work, along with teaching and training in entrepreneurship and management.",
    icon: '',
    sort_order: 1,
    published: true,
    created_at: '2026-01-01',
  ...
  },
  {
    ...
    description: "Helping early-stage founders think through business models, financial projections, and pitch materials, informed by my own experience building ventures.",
    for_whom: "Early-stage founders, particularly those building in Haiti or for diaspora communities.",
    deliverables: "Thoughtful feedback on business models, financial projections, and pitch materials.",
    outcomes: "Hands-on experience building ventures such as Creasti and FINANCEM, and graduate business training at Colorado State University.",
    icon: '',
    sort_order: 2,
    published: true,
    created_at: '2026-01-01',
  ...
  },
  {
    ...
    description: "Planning and coordinating projects with a focus on clear structure and stakeholder alignment, drawing on graduate training in project management and years of experience as Chief of Staff at Haiti's National Port Authority.",
    for_whom: "Organizations running multi-stakeholder projects or initiatives.",
    deliverables: "Project plans, timelines, coordination structures, and progress tracking.",
    outcomes: "Master in Project Management from the University for International Cooperation (Costa Rica) and years of experience as Chief of Staff and Advisor at Haiti's National Port Authority.",
    icon: '',
    sort_order: 3,
    published: true,
    created_at: '2026-01-01',
  ...
  },
  {
    ...
    description: "Contributing to sustainability work such as greenhouse gas inventories and impact assessment, building on my corporate sustainability fellowship and Impact MBA training.",
    for_whom: "Companies and organizations beginning to measure and improve their environmental impact.",
    deliverables: "Support with greenhouse gas inventories, sustainability research, and impact assessment.",
    outcomes: "Corporate Sustainability Fellowship (2025) and a Master of Business Administration (Impact MBA) from Colorado State University.",
    icon: '',
    sort_order: 4,
    published: true,
    created_at: '2026-01-01',
  ...
  {
    id: 'fs-6',
    title: "Haiti Market & Diaspora Insight",
    description: "Sharing on-the-ground knowledge of Haiti's business environment, institutions, and diaspora networks for organizations exploring work in or with Haiti.",
    for_whom: "Businesses, investors, NGOs, and diaspora members exploring work in or with Haiti.",
    deliverables: "Context on Haiti's business environment, institutions, and regional differences, and practical considerations for entering the market.",
    outcomes: "Years of public-sector leadership in Haiti, university teaching at four Haitian institutions, and research on barriers to entrepreneurship in Haiti's provincial cities.",
    icon: '',
    sort_order: 5,
    published: true,
    created_at: '2026-01-01',
